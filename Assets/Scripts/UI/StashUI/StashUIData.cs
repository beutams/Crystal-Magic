...
public class StashUIData : UIData
{
    ...
    public UINode StashView_Viewport_Content_StashItem_Mask;
    public UINode StashView_Viewport_Content_StashItem_Mask_Icon;
    ...
    public override void Bind(Transform root)
    {
        ...
        StashView_BG = UINode.From(Find(root, "StashView/BG"));
        ...
        StashView_Viewport_Content_StashItem_Mask = UINode.From(Find(root, "StashView/Viewport/Content/StashItem/Mask"));
        StashView_Viewport_Content_StashItem_Mask_Icon = UINode.From(Find(root, "StashView/Viewport/Content/StashItem/Mask/Icon"));
        ...
        ButtonList_All_Default_Icon = UINode.From(Find(root, "ButtonList/All/Default/Icon"));
        ButtonList_All_Select = UINode.From(Find(root, "ButtonList/All/Select"));
        ButtonList_All_Select_Icon = UINode.From(Find(root, "ButtonList/All/Select/Icon"));
        ...
        ButtonList_Skill_Default_Icon = UINode.From(Find(root, "ButtonList/Skill/Default/Icon"));
        ButtonList_Skill_Select = UINode.From(Find(root, "ButtonList/Skill/Select"));
        ButtonList_Skill_Select_Icon = UINode.From(Find(root, "ButtonList/Skill/Select/Icon"));
        ...
        ButtonList_Equip_Default_Icon = UINode.From(Find(root, "ButtonList/Equip/Default/Icon"));
        ButtonList_Equip_Select = UINode.From(Find(root, "ButtonList/Equip/Select"));
        ButtonList_Equip_Select_Icon = UINode.From(Find(root, "ButtonList/Equip/Select/Icon"));
        ...
        ButtonList_Props_Default_Icon = UINode.From(Find(root, "ButtonList/Props/Default/Icon"));
        ButtonList_Props_Select = UINode.From(Find(root, "ButtonList/Props/Select"));
        ButtonList_Props_Select_Icon = UINode.From(Find(root, "ButtonList/Props/Select/Icon"));
