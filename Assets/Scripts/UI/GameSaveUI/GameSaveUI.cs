...
public class GameSaveUI : UIBase<GameSaveUIData>
{
    private readonly List<SaveUI_SaveItemView> _itemViews = new();
    private GameSaveUIModel _model;
    ...
    public void BindModel(GameSaveUIModel model)
    {
        if (_model == model)
            return;
    ...
    {
        GameSaveUIModel eventModel = gameEvent.GetData<GameSaveUIModel>();
    ...
    private void SubscribeModelEvents()
    {
        ...
        EventComponent.Instance.Subscribe(new CommonGameEvent(GameSaveUIModel.SaveRecordsChangedEventName), OnSaveRecordsChanged);
    ...
    private void UnsubscribeModelEvents()
    {
        ...
        EventComponent.Instance.Unsubscribe(new CommonGameEvent(GameSaveUIModel.SaveRecordsChangedEventName), OnSaveRecordsChanged);
