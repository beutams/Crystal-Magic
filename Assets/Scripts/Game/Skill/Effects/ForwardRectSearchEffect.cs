...
namespace CrystalMagic.Game.Skill.Effects
{
    public sealed class ForwardRectSearchEffect : Effect
    {
        ...
        public ForwardRectSearchEffect(ForwardRectSearchEffectData data) : base(data) => Data = data;
        ...
        public override void Execute(SkillContent context)
        {
            ...
            UnitQueryShape shape = UnitQueryShape.ForwardRect(originPosition, forward, Data.Length, Data.Width);
