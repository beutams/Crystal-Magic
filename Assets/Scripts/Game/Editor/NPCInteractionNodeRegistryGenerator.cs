...
{
    private const string NodeDataOutputPath = "Assets/Scripts/Game/NPCInteraction/NPCInteractionNodeDataRegistry.cs";
    private const string RunnerOutputPath = "Assets/Scripts/Game/NPCInteraction/NPCInteractionNodeRunnerRegistry.cs";
